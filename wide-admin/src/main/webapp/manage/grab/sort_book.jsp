...
<head>
	...
	<title>后台管理系统_抓取分类书籍</title>
</head>
<body>
	<div class="container">
		<div class="content-search">
			<form class="layui-form layui-inline" action="/manage/grab/book" method="post">
				...
				<div class="layui-input-inline">
					...
					<div class="layui-input-block" >
						<select name="partnerSortType" id="partnerSort" lay-verify="required" lay-filter="partnerSort">
				...
				<div class="layui-input-inline">
					...
					<div class="layui-input-block" >
						<select name="subSortType" id="subSort">
				...
				<div class="layui-input-inline">
					...
					<div class="layui-input-block" >
						<select name="status" id="status">
							<option value="over" selected>完结</option>
							<option value="hot">热门</option>
							<option value="new">新书</option>
							<option value="reputation">好评</option>
